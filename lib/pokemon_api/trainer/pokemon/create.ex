defmodule PokemonApi.Trainer.Pokemon.Create do
  alias PokemonApi.Pokemon
  alias PokemonApi.Trainer.Pokemon, as: TrainerPokemon
  ...
  defp handle_build({:error, _changest} = error), do: error
end
